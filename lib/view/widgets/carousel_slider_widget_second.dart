...
class CarouselSliderWidgetStateSecond extends StatefulWidget {
  const CarouselSliderWidgetStateSecond({Key? key}) : super(key: key);

  @override
  CarouselSliderWidgetState createState() => CarouselSliderWidgetState();
}

class CarouselSliderWidgetState extends State<CarouselSliderWidgetStateSecond> {
